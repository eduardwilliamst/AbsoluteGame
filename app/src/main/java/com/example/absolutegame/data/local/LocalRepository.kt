...
import com.example.absolutegame.domain.repository.ProfileRepository
import com.example.absolutegame.domain.repository.RegisterRepository
...
class LocalRepository(
    ...
    override suspend fun authenticate(username: String, password: String): String {
        delay(1000)
        return if (username == "willy" && password == "123456") {
            "token"
        } else {
